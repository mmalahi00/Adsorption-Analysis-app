...
TRANSLATIONS = {
    "fr": {
        ...
        "download_png_button": "📥 Télécharger la Figure (PNG)",
        ...
        "calib_tab_enter_data_info": "Entrez des données d'étalonnage valides dans la barre latérale.",
        "calib_plot_error_warning": "Erreur lors de la création du graphique d'étealonage: {e_plot}",
        ...
        "isotherm_error_export_langmuir_lin_Ce_div_qe": "Erreur export Langmuir linéarisé (Ce/qe vs Ce): {e}",
        ...
        "isotherm_info_params_not_calculated": "Les paramètres n'ont pas pu être calculés à partir des ajustements linéarisés (vérifiez les données, les graphiques et les messages).",
        ...
        "isotherm_nonlinear_header": "##### Ajustement des Modèles Non-Linéaires",
        "isotherm_nonlinear_caption": "Les paramètres sont déterminés directement à partir de l'ajustement de qe vs Ce.",
        "isotherm_langmuir_nl_header": "###### Langmuir Non-Linéaire",
        "isotherm_freundlich_nl_header": "###### Freundlich Non-Linéaire",
        "isotherm_nl_plot_title": "Ajustement Non-Linéaire: {model_name} (R²={r2_nl:.4f})",
        "isotherm_nl_legend_fit": "Ajustement {model_name}",
        "isotherm_langmuir_nl_caption": "Paramètres: qm = {qm_nl:.3f} mg/g, KL = {KL_nl:.3f} L/mg, R² = {r2_nl:.4f}",
        "isotherm_freundlich_nl_caption": "Paramètres: KF = {KF_nl:.3f} (mg/g)(L/mg)¹/ⁿ, n = {n_nl:.3f}, R² = {r2_nl:.4f}",
        "isotherm_nl_fitting_spinner": "Ajustement non-linéaire pour {model_name}...",
        "isotherm_nl_fit_error": "Erreur lors de l'ajustement non-linéaire de {model_name}: {e}",
        "isotherm_derived_params_nl_header": "##### Paramètres Dérivés des Modèles Non-Linéaires",
        "isotherm_no_valid_data_nl": "Pas de données valides (Ce>0, qe>=0) pour l'ajustement non-linéaire.",
        "isotherm_temkin_lin_header": "###### Temkin Linéarisé (qe vs ln Ce)",
        "isotherm_temkin_nl_header": "###### Temkin Non-Linéaire",
        "isotherm_temkin_lin_caption": "Pente = {slope_T_lin:.3f} (B₁), Intercept = {intercept_T_lin:.3f} (B₁ ln Kᴛ)\nKᴛ = {KT_lin:.3f} L/mg, B₁ = {B1_lin:.3f} mg/g (RT/bᴛ)",
        "isotherm_temkin_nl_caption": "Paramètres: B₁ = {B1_nl:.3f} mg/g (RT/bᴛ), Kᴛ = {KT_nl:.3f} L/mg, R² = {r2_nl:.4f}",
        "isotherm_input_temp_for_bT_label": "Température pour calcul bᴛ (K)",
        ...
        "kinetic_nonlinear_header": "1. Modèles Non-Linéaires (qt vs t)",
        "kinetic_nl_data_display_header": "Paramètres Cinétiques Non-Linéaires",
        "kinetic_nl_legend_fit": "Ajustement {model_name}",
        "kinetic_spinner_qt_calc": "Calcul de qt pour la cinétique...",
        "kinetic_error_qt_calc_slope_zero": "Erreur lors du calcul de Ct/qt : la pente de l'étalonnage est nulle ou quasi nulle.",
        "kinetic_success_qt_calc": "Calcul de qt pour la cinétique terminé.",
        "kinetic_error_qt_calc_div_by_zero": "Erreur lors du calcul de Ct/qt : division par zéro détectée (pente d'étalonnage nulle ?).",
        "kinetic_error_qt_calc_general": "Erreur lors du calcul de qt pour la cinétique : {e_qt}",
        "kinetic_error_missing_abs_t_col": "Colonne 'Absorbance_t' manquante dans les données cinétiques.",
        "kinetic_error_mass_volume_non_positive": "La masse de l’adsorbant et le volume doivent être positifs pour le calcul de qt.",
        ...
        "kinetic_error_export_qt_vs_t": "Erreur lors de l’export de qt vs t : {e}",
        ...
        "kinetic_warning_pfo_nl_calc_failed": "Échec du calcul des paramètres PFO (non linéaire) : {e}",
        "kinetic_spinner_pso_nl_calc": "Calcul des paramètres PSO (non linéaire)...",
        "kinetic_warning_pso_nl_calc_failed": "Échec du calcul des paramètres PSO (non linéaire) : {e}",
        "kinetic_spinner_ipd_analysis": "Analyse de la Diffusion Intraparticulaire (IPD)...",
        "kinetic_warning_ipd_insufficient_variation": "Variation insuffisante de √t ou qt pour la régression IPD.",
        "kinetic_warning_ipd_calc_failed_regression": "Échec du calcul IPD (régression linéaire) : {ve}",
        "kinetic_warning_ipd_calc_failed_general": "Échec du calcul IPD : {e}",
        "kinetic_warning_ipd_not_enough_points": "Pas assez de points (Temps > 0) pour l’analyse IPD.",
        "kinetic_linearized_models_subheader": "2. Analyse des Modèles Linéarisés",
        "kinetic_pfo_lin_header": "###### PFO Linéarisé: ln(qe-qt) vs t",
        "kinetic_warning_pfo_lin_insufficient_variation": "Variation insuffisante pour la régression PFO linéarisée.",
        "kinetic_pfo_lin_plot_title": "PFO Linéarisé (R²={r2_pfo_lin:.4f})",
        "kinetic_pfo_lin_plot_xaxis": "Temps (min)",
        "kinetic_pfo_lin_caption": "Pente = {slope_pfo_lin:.4f} (-k1), Ordonnée = {intercept_pfo_lin:.4f} (ln qe)\nR² = {r2_pfo_lin:.4f}, k1_lin = {k1_lin:.4f} min⁻¹",
        "kinetic_download_pfo_lin_filename": "pfo_lineaire.png",
        "kinetic_error_export_pfo_lin": "Erreur lors de l’export du PFO linéarisé : {e}",
        "kinetic_error_pfo_lin_plot_regression": "Erreur dans le tracé du PFO linéarisé (régression) : {ve}",
        "kinetic_error_pfo_lin_plot_general": "Erreur dans le tracé du PFO linéarisé : {e_pfo_lin}",
        "kinetic_warning_pfo_lin_not_enough_points": "Pas assez de points valides (t>0, qt < qe_calc) pour le tracé PFO linéarisé.",
        "kinetic_warning_pfo_nl_calc_required": "Le calcul non linéaire des paramètres PFO (pour qe) est requis mais a échoué.",
        "kinetic_info_pfo_lin_uses_nl_qe": "Le tracé du PFO linéarisé utilise la valeur `qe` déterminée par ajustement non linéaire.",
        "kinetic_pso_lin_header": "###### PSO Linéarisé: t/qt vs t",
        "kinetic_warning_pso_lin_insufficient_variation": "Variation insuffisante pour la régression PSO linéarisée.",
        "kinetic_pso_lin_plot_title": "PSO Linéarisé (R²={r2_pso_lin:.4f})",
        "kinetic_pso_lin_caption": "Pente = {slope_pso_lin:.4f} (1/qe), Ordonnée = {intercept_pso_lin:.4f} (1/(k2·qe²))\nR² = {r2_pso_lin:.4f}, qe_lin = {qe_lin:.3f} mg/g, k2_lin = {k2_lin:.4f} g·mg⁻¹·min⁻¹",
        "kinetic_download_pso_lin_filename": "pso_lineaire.png",
        "kinetic_error_export_pso_lin": "Erreur lors de l’export du PSO linéarisé : {e}",
        "kinetic_error_pso_lin_plot_regression": "Erreur dans le tracé du PSO linéarisé (régression) : {ve}",
        "kinetic_error_pso_lin_plot_general": "Erreur dans le tracé du PSO linéarisé : {e_pso_lin}",
        "kinetic_warning_pso_lin_not_enough_points": "Pas assez de points valides (t>0 et qt>0) pour le tracé PSO linéarisé.",
        ...
        "kinetic_ipd_caption_interp": "Si la droite ne passe pas par l’origine (C ≠ 0), la diffusion intraparticulaire n’est pas l’unique étape limitante.",
        "kinetic_download_ipd_lin_filename": "ipd_lineaire.png",
        "kinetic_error_export_ipd_lin": "Erreur lors de l’export de l’IPD linéaire : {e}",
        "kinetic_warning_ipd_params_calc_failed": "Échec du calcul des paramètres IPD.",
        "kinetic_info_ipd_fit_unavailable": "Ajustement IPD indisponible (pas assez de points ou erreur de calcul).",
        "kinetic_warning_no_data_for_ipd": "Aucune donnée cinétique à tracer pour l’IPD.",
        "kinetic_warning_less_than_3_points": "Moins de 3 points de données cinétiques disponibles. Impossible d’analyser les modèles.",
        "kinetic_warning_qt_calc_no_results": "Le calcul de qt n’a produit aucun résultat valide.",
        "kinetic_warning_provide_calib_data": "Veuillez d'abord fournir des données d’étalonnage valides.",
        "kinetic_info_enter_kinetic_data": "Veuillez entrer les données pour l’étude cinétique.",
        ...
        "temp_effect_error_export_styled_plot": "Erreur export figure température : {e_export_temp}",
    ...
    "en": {
        ...
        "download_png_button": "📥 Download Figure (PNG)",
        ...
        "isotherm_linearization_caption": "Parameters (qm, KL, KF, n, KT, B₁) are determined from these linear regressions.",
        ...
        "isotherm_freundlich_nl_caption": "Parameters: KF = {KF_nl:.3f} (mg/g)(L/mg)¹/ⁿ, n = {n_nl:.3f}, R² = {r2_nl:.4f}",
        ...
        "isotherm_temkin_lin_caption": "Slope = {slope_T_lin:.3f} (B₁), Intercept = {intercept_T_lin:.3f} (B₁ ln Kᴛ)\nKᴛ = {KT_lin:.3f} L/mg, B₁ = {B1_lin:.3f} mg/g (RT/bᴛ)",
        "isotherm_temkin_nl_caption": "Parameters: B₁ = {B1_nl:.3f} mg/g (RT/bᴛ), Kᴛ = {KT_nl:.3f} L/mg, R² = {r2_nl:.4f}",
        "isotherm_input_temp_for_bT_label": "Temperature for bᴛ calculation (K)",
